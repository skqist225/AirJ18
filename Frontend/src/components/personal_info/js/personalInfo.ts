...
const prefixUrl: string = `${process.env.REACT_APP_SERVER_URL}`;
...
//     newPassword: string,
//     userId: number,
//     oldPasswordError: JQuery<HTMLElement>,
//     newPasswordError: JQuery<HTMLElement>,
//     displayError: JQuery<HTMLElement>,
//     form: JQuery<HTMLFormElement>
// ) {
//     const { data } = await api.post(`${prefixUrl}/user/check-password-constraint`, {
//         oldPassword,
//         newPassword,
//         userId,
//     });
...
async function checkFirstNameAndLastNameConstraint(
    firstName: string,
    lastName: string,
    firstNameError: JQuery<HTMLElement>,
    lastNameError: JQuery<HTMLElement>,
    displayError: JQuery<HTMLElement>,
    form: JQuery<HTMLFormElement>
) {
    const { data } = await api.post(`${prefixUrl}/user/check-first-name-and-last-name-constraint`, {
        firstName,
        lastName,
    });
